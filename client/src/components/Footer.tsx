        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-4">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/searchmadarth" className="text-gray-400 hover:text-[#B2F74D]" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                <Icon name="facebook" />
              </a>
              <a href="https://www.linkedin.com/company/searchmadarth/" className="text-gray-400 hover:text-[#B2F74D]" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
                <Icon name="linkedin" />
              </a>
              <a href="https://www.instagram.com/searchmadarth/" className="text-gray-400 hover:text-[#B2F74D]" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                <Icon name="instagram" />
              </a>
            </div>
          </div>
