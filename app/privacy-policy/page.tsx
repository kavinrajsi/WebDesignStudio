      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="prose max-w-none">
            ...
            <p>
              Welcome to Search Madarth&reg; (&quot;we,&quot; &quot;our,&quot;
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                ...
                information you provide directly to us, such as when you create
                an account, fill out a form, submit a request, participate in
                interactive features, or communicate with us.
              </li>
              <li>
                <strong>Information we collect automatically:</strong> When you
                access or use our Services, we may automatically collect
                information about you, including:
                <ul className="list-disc pl-6 mt-2">
                  <li>
                    Log Information: We collect log information about your use
                    of the Services, including the type of browser you use,
                    access times, pages viewed, your IP address, and the page
                  ...
                  <li>
                    Usage Information: We collect information about your use of
                    our Services, such as the actions you take and the features
                    you engage with.
                  </li>
                </ul>
              </li>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                ...
                promotions, and provide news and information we think will be of
                interest to you;
              </li>
              <li>
              ...
              <li>
                ...
                Search Madarth&reg; and others;
              </li>
              <li>
                Personalize and improve the Services and provide content,
                features, or advertisements that match your interests and
                preferences;
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                ...
                safety of Search Madarth&reg; or others;
              </li>
              <li>
              ...
              <li>
                Between and among Search Madarth&reg; and our current and future
            ...
            <p>
              ...
              delete your account information at any time by logging into your
              online account or by contacting us. If you wish to delete or
              deactivate your account, please note that we may retain certain
            ...
            <p>
              ...
              you are a parent or guardian and you believe your child has
            ...
            <p>
              ...
              notice. We encourage you to review the Privacy Policy whenever you
              access the Services to stay informed about our information
              practices.
            </p>
            ...
            <p className="mb-4">
              Email: admin@madarth.com
              <br />
              Address: 4, Alamelu Manga Puram Rd, Saradapuram, Mylapore,
